      ...
      <header class="masthead">
        ...
        <div class="container mt-3 mb-3">
            ...
            <form action="Control" method="post">
                ...
                <label>Nombre</label>
                <input type="text" class="form-control" name="nombre" value="${catpro.getNombre()}"><br>
                <input class="btn btn-outline-primary" type="submit" name="accion" value="Editar categoria">
            </form>
        </div>
        </div> 
